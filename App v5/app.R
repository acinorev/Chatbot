               ...
               column(5,
                      ...
                      wellPanel(style=" border-color: #8b8b8b; background-color: DeepSkyBlue",
                                ...
                                conditionalPanel( "input.chatbot_class == 'Others'", 
                                                  wellPanel( 
                                                      style=" 1px solid #ccc; padding:1em; color:#535559; font-size:20px; background-color: DeepSkyBlue",
                                                      tags$a(href="https://zuehlke-bot.herokuapp.com", target="_blank", tags$h4("Ask questions to Zuehlke bot. Click here!"))
                                                  ))
                      ),
                      wellPanel(style="border-color: #8b8b8b; background-color: DeepSkyBlue",
                                textAreaInput(inputId="chatbot_class",label="Your message is classified as", rows=1, value =  "Household")),
